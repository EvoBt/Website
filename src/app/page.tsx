...
const perks = [
  ...
  },
  {
    ...
    icon: Leaf,
    description:
      "We've pledge 1% of sales to the preservartion and restoration of the natural environment.",
  },
];
      ...
      <MaxWidthWrapper>
        <div className="py-20 mx-auto text-center flex flex-col items-center max-w-3xl">
          <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
            Your marktplace for hight-quality {""}
            ...
            {perks.map((perk) => (
              ...
              >
                ...
                <div className="mt-6 md:ml-4 md:mt-0 lg:ml-0 lg:mt-6">
                  <h3 className="text-base font-medium text-gray0900">
                    {perk.name}
